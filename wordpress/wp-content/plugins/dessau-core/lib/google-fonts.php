<?php
if ( ! function_exists( 'dessau_select_init_google_fonts_array' ) ) {
    function dessau_select_init_google_fonts_array() {
        ...
        $dessau_select_fonts_array = $google_fonts_decoded['items'];
    }
    add_action('after_setup_theme', 'dessau_select_init_google_fonts_array');
}