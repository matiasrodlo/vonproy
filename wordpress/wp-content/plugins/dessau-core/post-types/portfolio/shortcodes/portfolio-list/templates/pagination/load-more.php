<?php if($query_results->max_num_pages > 1) {
	...
	<div class="qodef-pl-load-more-holder">
		<div class="qodef-pl-load-more" <?php dessau_select_inline_style($holder_styles); ?>>
			<?php 
				echo dessau_select_get_button_html(array(
					'link' => 'javascript: void(0)',
					'size' => 'normal',
					'type' => 'outline',
					'text' => esc_html__('LOAD MORE', 'dessau-core')
				));
			?>
		</div>
	</div>
