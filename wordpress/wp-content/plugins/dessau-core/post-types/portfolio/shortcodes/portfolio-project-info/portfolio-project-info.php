...
class PortfolioProjectInfo implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'     => esc_html__( 'Portfolio Project Info', 'dessau-core' ),
					'base'     => $this->getBase(),
					...
					'params'   => array(
						array(
							...
							'heading'     => esc_html__( 'Selected Project', 'dessau-core' ),
							'settings'    => array(
								'sortable'      => true,
								'unique_values' => true
							),
							'description' => esc_html__( 'If you left this field empty then project ID will be of the current page', 'dessau-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'project_info_type',
							'heading'     => esc_html__( 'Project Info Type', 'dessau-core' ),
							'value'       => array(
								esc_html__( 'Title', 'dessau-core' )          => 'title',
								esc_html__( 'Category', 'dessau-core' )       => 'category',
								esc_html__( 'Tag', 'dessau-core' )            => 'tag',
								esc_html__( 'Author', 'dessau-core' )         => 'author',
								esc_html__( 'Date', 'dessau-core' )           => 'date',
								esc_html__( 'Featured Image', 'dessau-core' ) => 'image'
							),
							'admin_label' => true
						),
						array(
							...
							'heading'     => esc_html__( 'Project Title Tag', 'dessau-core' ),
							'value'       => array_flip( dessau_select_get_title_tag( true, array( 'p' => 'p' ) ) ),
							'description' => esc_html__( 'Set title tag for project title element', 'dessau-core' ),
							'dependency'  => array( 'element' => 'project_info_type', 'value' => array( 'title' ) )
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'project_info_title',
							'heading'     => esc_html__( 'Project Info Label', 'dessau-core' ),
							'description' => esc_html__( 'Add project info label before project info element/s', 'dessau-core' )
						),
						array(
							'type'       => 'dropdown',
							'param_name' => 'project_info_title_tag',
							'heading'    => esc_html__( 'Project Info Label Tag', 'dessau-core' ),
							'value'      => array_flip( dessau_select_get_title_tag( true, array( 'p' => 'p' ) ) ),
	...
	public function render( $atts, $content = null ) {
		...
		$html = '<div class="qodef-portfolio-project-info">';

		if ( !empty( $params['project_info_title'] ) ) {
			$html .= '<' . esc_attr( $project_info_title_tag ) . ' class="qodef-ppi-label">' . esc_html( $params['project_info_title'] ) . '</' . esc_attr( $project_info_title_tag ) . '>';
		}
