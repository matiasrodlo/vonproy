<?php
$masonry_classes   = '';
$number_of_columns = dessau_select_get_meta_field_intersect( 'portfolio_single_masonry_columns_number' );
if ( ! empty( $number_of_columns ) ) {
	$masonry_classes .= ' qodef-' . $number_of_columns . '-columns';
}
$space_between_items = dessau_select_get_meta_field_intersect( 'portfolio_single_masonry_space_between_items' );
...
<div class="qodef-grid-row">
	<div class="qodef-grid-col-8">
		<?php dessau_core_get_cpt_single_module_template_part('templates/single/parts/title', 'portfolio', $item_layout);
