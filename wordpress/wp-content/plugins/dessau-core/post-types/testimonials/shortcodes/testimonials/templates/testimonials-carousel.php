<div class="qodef-testimonials-holder clearfix <?php echo esc_attr($holder_classes); ?>">
    <div class="qodef-testimonials qodef-owl-custom-slider qodef-testimonials-main" <?php echo dessau_select_get_inline_attrs( $data_attr ) ?>>
    ...
    <div class="qodef-testimonial-image-nav qodef-owl-custom-slider">
        <?php foreach ($pagination_images as $image) { ?>
            <div class="qodef-testimonial-image"><?php print dessau_select_get_module_part($image);?></div>
        <?php } ?>
    </div>
