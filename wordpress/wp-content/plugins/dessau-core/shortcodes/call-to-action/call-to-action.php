<?php
namespace DessauCore\CPT\Shortcodes\CallToAction;
...
class CallToAction implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Call To Action', 'dessau-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							'type'        => 'dropdown',
							'param_name'  => 'layout',
							'heading'     => esc_html__( 'Layout', 'dessau-core' ),
							'value'       => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Set Content In Grid', 'dessau-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Content Elements Proportion', 'dessau-core' ),
							'value'      => array(
								esc_html__( '80/20', 'dessau-core' ) => '80',
								esc_html__( '75/25', 'dessau-core' ) => '75',
								esc_html__( '66/33', 'dessau-core' ) => '66',
								esc_html__( '50/50', 'dessau-core' ) => '50'
							),
							'dependency' => array( 'element' => 'layout', 'value' => array( 'normal' ) )
						),
						array(
						...
						array(
							...
							'heading'    => esc_html__( 'Button Top Margin (px)', 'dessau-core' ),
						...
						array(
							'type'       => 'textarea_html',
							'param_name' => 'content',
							'heading'    => esc_html__( 'Content', 'dessau-core' ),
							'value'      => esc_html__( 'I am test text for Call to Action shortcode content', 'dessau-core' )
						)
					)
				)
			);
	...
	public function render( $atts, $content = null ) {
		...
		$html = dessau_core_get_shortcode_module_template_part( 'templates/call-to-action', 'call-to-action', '', $params );
	...
	private function getButtonHolderStyles( $params ) {
		...
		if ( ! empty( $params['button_top_margin'] ) && $params['layout'] === 'simple' ) {
			$styles[] = 'margin-top: ' . dessau_select_filter_px( $params['button_top_margin'] ) . 'px';
		}
