...
class FullScreenImageSlider implements Lib\ShortcodeInterface {
	...
	public function __construct() {
		$this->base = 'qodef_full_screen_image_slider';
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Full Screen Image Slider', 'dessau-core' ),
					'base'                      => $this->getBase(),
					'category'                  => esc_html__( 'by DESSAU', 'dessau-core' ),
					'as_parent'                 => array( 'only' => 'qodef_full_screen_image_slider_item' ),
	...
	public function render( $atts, $content = null ) {
		...
		$html = dessau_core_get_shortcode_module_template_part( 'templates/full-screen-image-slider', 'full-screen-image-slider', '', $params );
