<?php
namespace DessauCore\CPT\Shortcodes\ProgressBar;
...
class ProgressBar implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Progress Bar', 'dessau-core' ),
					'base'                      => $this->base,
					...
					'params'                    => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Percentage Type', 'dessau-core' ),
							'value'      => array(
								esc_html__( 'Default', 'dessau-core' )  => '',
								esc_html__( 'Floating', 'dessau-core' ) => 'floating'
							),
						...
						array(
							...
							'heading'    => esc_html__( 'Active Color', 'dessau-core' )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'color_inactive',
							'heading'    => esc_html__( 'Inactive Color', 'dessau-core' )
						)
					)
				)
			);
	...
	public function render( $atts, $content = null ) {
		...
		$html = dessau_core_get_shortcode_module_template_part( 'templates/progress-bar-template', 'progress-bar', '', $params );
