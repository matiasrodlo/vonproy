<?php
namespace DessauCore\CPT\Shortcodes\SplitSection;
...
class SplitSection implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'     => esc_html__( 'Split Section', 'dessau-core' ),
					'base'     => $this->base,
					...
					'params'   => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Image Position', 'dessau-core' ),
							'value'       => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Content Background Color', 'dessau-core' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'title',
						...
						array(
							...
							'heading'    => esc_html__( 'Text Top Margin (px or %)', 'dessau-core' ),
							'dependency' => array( 'element' => 'text', 'not_empty' => true )
						),
						array(
							'type'       => 'textfield',
						...
						array(
							...
							'heading'     => esc_html__( 'Button Type', 'dessau-core' ),
							'value'       => array(
								esc_html__( 'Solid', 'dessau-core' )   => 'solid',
								esc_html__( 'Outline', 'dessau-core' ) => 'outline',
								esc_html__( 'Text', 'dessau-core' )    => 'simple'
							),
							'save_always' => true,
							'dependency'  => array( 'element' => 'button_text', 'not_empty' => true ),
							'group'       => esc_html__( 'Button Style', 'dessau-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'button_size',
							'heading'     => esc_html__( 'Button Size', 'dessau-core' ),
							'value'       => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Button Link Target', 'dessau-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Button Color', 'dessau-core' ),
							'dependency' => array( 'element' => 'button_text', 'not_empty' => true ),
							'group'      => esc_html__( 'Button Style', 'dessau-core' )
						),
						array(
							...
							'heading'    => esc_html__( 'Button Hover Color', 'dessau-core' ),
							'dependency' => array( 'element' => 'button_text', 'not_empty' => true ),
							'group'      => esc_html__( 'Button Style', 'dessau-core' ),
						),
						array(
							...
							'heading'    => esc_html__( 'Button Background Color', 'dessau-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Button Hover Background Color', 'dessau-core' ),
							'dependency' => array( 'element' => 'button_type', 'value' => array( 'solid' ) ),
							'group'      => esc_html__( 'Button Style', 'dessau-core' )
						),
						array(
							...
							'heading'    => esc_html__( 'Button Border Color', 'dessau-core' ),
							'dependency' => array( 'element' => 'button_text', 'not_empty' => true ),
							'group'      => esc_html__( 'Button Style', 'dessau-core' )
						),
						array(
							...
							'heading'    => esc_html__( 'Button Hover Border Color', 'dessau-core' ),
							'dependency' => array( 'element' => 'button_text', 'not_empty' => true ),
							'group'      => esc_html__( 'Button Style', 'dessau-core' )
						),
						array(
							...
							'heading'    => esc_html__( 'Button Top Margin (px or %)', 'dessau-core' ),
							'dependency' => array( 'element' => 'button_text', 'not_empty' => true ),
							'group'      => esc_html__( 'Button Style', 'dessau-core' )
						),
						array(
							...
							'heading'     => esc_html__( 'Responsive Breakpoint', 'dessau-core' ),
							'value'       => array(
								esc_html__( 'Never', 'dessau-core' )        => '',
							...
							'description' => esc_html__( 'Choose on which stage you want to break image and text content to be one under other', 'dessau-core' ),
							'save_always' => true
						)
					)
				)
	...
	public function render( $atts, $content = null ) {
		...
		$html = dessau_core_get_shortcode_module_template_part( 'templates/split-section', 'split-section', '', $params );
	...
	private function getTextStyles( $params ) {
		...
		if ( $params['text_top_margin'] !== '' ) {
			if ( dessau_select_string_ends_with( $params['text_top_margin'], '%' ) || dessau_select_string_ends_with( $params['text_top_margin'], 'px' ) ) {
