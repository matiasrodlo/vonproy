...
include 'dessau-instagram-helper.php';

/**
 * Class DessauInstagramApi
 */
class DessauInstagramApi {
    /**
    ...
    private $apiURL;
    /**
     * @var DessauInstagramApi instance of current class
     */
    private static $instance;

    /**
     * Helper object
     * @var DessauInstagramHelper
     */
    private $helper;

    const CODE_OPTION_NAME = 'dessau_instagram_code';
    const USER_ID_OPTION_NAME = 'dessau_instagram_user_id';
    const ACCESS_TOKEN_OPTION_NAME = 'dessau_instagram_access_token';
    const CODE_REDIRECT_URI_OPTION_NAME = 'dessau_instagram_code_redirect_uri';
    ...
    private function __construct() {
        ...
        $this->redirectUri = defined( 'SELECT_PROFILE_SLUG' ) ?  'http://demo.' . SELECT_PROFILE_SLUG . '-themes.com/instagram-app/instagram-redirect.php' : '';
        ...
        $this->helper = new DessauInstagramHelper();
    }
     ...
     * @return string
     *
     * @see DessauInstagramApi::buildCurrentPageURI()
     */
     ...
     *
     * @see DessauInstagramApi::fetchData()
     */
     ...
     * @return stdClass
     *
     * @see DessauInstagramApi::getAccessToken()
     */
