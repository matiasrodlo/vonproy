...
/**
 * Class DessauInstagramHelper
 */
class DessauInstagramHelper {
    /**
     * Generates HTML for given image from Instagram feed. Defines dessau_instagram_image_atts filter
    ...
    public function getImageHTML($image, $imageSize) {
        ...
        $imageAtts = apply_filters('dessau_instagram_image_atts',
            array(
                'class' => $imageSize,
