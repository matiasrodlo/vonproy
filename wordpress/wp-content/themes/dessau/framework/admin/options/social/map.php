	...
	function dessau_select_social_options_map() {
		...
		dessau_select_add_admin_section_title(
			array(
				...
				'title'  => esc_html__( 'Share on Google Plus', 'dessau' )
			)
		);
		...
		dessau_select_add_admin_field(
			array(
				...
				'default_value' => 'no',
				'label'         => esc_html__( 'Enable Share', 'dessau' ),
				'description'   => esc_html__( 'Enabling this option will allow sharing via Google Plus', 'dessau' ),
				'parent'        => $panel_social_networks
			)
		);
		
		$enable_google_plus_container = dessau_select_add_admin_container(
			array(
