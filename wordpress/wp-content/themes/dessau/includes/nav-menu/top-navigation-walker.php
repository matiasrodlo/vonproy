...
if (!class_exists('DessauSelectTopNavigationWalker')) {
	class DessauSelectTopNavigationWalker extends Walker_Nav_Menu {
		...
		function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			if($item->hide == ""){
				...
				if($args->has_children && $depth == 0) {
					$item_output .= '<i class="qodef-menu-arrow arrow_carrot-down"></i>';
				}
