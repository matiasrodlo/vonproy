...
if ( $row_content_width === 'grid' ) {
	$qodef_row_wrapper_start .= '<div class="qodef-row-grid-section-wrapper ' . esc_attr( $grid_row_classes ) . '" ' . esc_attr( $grid_row_datas ) . ' ' . dessau_select_get_inline_style( $qodef_grid_row_styles ) . '><div class="qodef-row-grid-section">';
...
$output .= '<div ' . implode( ' ', $wrapper_attributes ) . ' ' . dessau_select_get_inline_style( $qodef_vc_row_styles ) . '>';
$output .= wpb_js_remove_wpautop( $content );
$output .= '</div>';
$output .= $qodef_row_wrapper_end;
$output .= $after_output;

print dessau_select_get_module_part($output);
